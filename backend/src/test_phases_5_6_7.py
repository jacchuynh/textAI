...
from backend.src.shared.models import Character, DomainType, Domain, Tag, TagCategory, ActionSignificanceTier, ResolutionMethod
from backend.src.game_engine.unified_progression_system import unified_progression_system
...
def test_phase_5_insight_spending():
    ...
    character.tags["diplomacy"] = Tag(name="diplomacy", category=TagCategory.SOCIAL, description="Skill in diplomatic negotiations", domains=[DomainType.SOCIAL], rank=3, xp=15)
...
def test_phase_6_mastery_paths():
    ...
    character.domains[DomainType.SOCIAL] = Domain(type=DomainType.SOCIAL, value=16, usage_count=20, growth_points=25)
    character.domains[DomainType.AUTHORITY] = Domain(type=DomainType.AUTHORITY, value=12, usage_count=15, growth_points=18)
    
    # Add required tags
    character.tags["diplomacy"] = Tag(name="diplomacy", category=TagCategory.SOCIAL, description="Diplomatic skill", domains=[DomainType.SOCIAL], rank=4, xp=40)
    character.tags["negotiation"] = Tag(name="negotiation", category=TagCategory.SOCIAL, description="Negotiation skill", domains=[DomainType.SOCIAL], rank=3, xp=30)
...
def test_phase_7_world_integration():
    ...
    character.domains[DomainType.AUTHORITY] = Domain(type=DomainType.AUTHORITY, value=14, usage_count=12, growth_points=20)
    character.tags["leadership"] = Tag(name="leadership", category=TagCategory.SOCIAL, description="Leadership skills", domains=[DomainType.AUTHORITY], rank=4, xp=35)
...
def test_integrated_progression_flow():
    ...
    character.domains[DomainType.SOCIAL] = Domain(type=DomainType.SOCIAL, value=10, usage_count=8, growth_points=15)
    character.tags["diplomacy"] = Tag(name="diplomacy", category=TagCategory.SOCIAL, description="Diplomatic negotiations", domains=[DomainType.SOCIAL], rank=3, xp=25)
