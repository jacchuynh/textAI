...
class EventType(str, Enum):
    ...
    SEASONAL_CHANGE_DETAILED = "SEASONAL_CHANGE_DETAILED"
    SEASONAL_ECONOMY_UPDATE = "SEASONAL_ECONOMY_UPDATE"
    SEASONAL_NPC_UPDATE = "SEASONAL_NPC_UPDATE"
    SEASONAL_WEATHER_UPDATE = "SEASONAL_WEATHER_UPDATE"
